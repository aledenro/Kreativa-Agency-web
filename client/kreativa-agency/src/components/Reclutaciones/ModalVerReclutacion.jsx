...
const ModalVerReclutacion = ({ show, handleClose, form, onUpdate }) => {
	...
	const handleDescargarCV = () => {
		if (currentForm.file) {
			window.open(currentForm.file, "_blank");
		} else {
			showNotification("error", "Esta reclutación no incluyó CV");
		}
	};
			...
			<Modal.Header closeButton>
				<Modal.Title>
					{`${currentForm.nombre} ${currentForm.apellido}` ||
						"Detalles de Reclutación"}
				</Modal.Title>
			</Modal.Header>
			<Modal.Body className="p-0">
				<div className="proyecto-modal-content" style={{ maxHeight: "600px" }}>
					<Tab.Container id="reclutacion-tabs" defaultActiveKey="detalles">
						...
						<Tab.Content>
							<Tab.Pane eventKey="detalles">
								<div className="p-4">
									<div className="d-flex justify-content-between align-items-center mb-3">
										<h5 className="mb-0">Información del Candidato</h5>
									</div>
										...
										<div className="row mb-3">
											<div className="col-md-6">
												<div className="info-item">
													...
													<div className="fw-medium">
														<a href={`tel:${currentForm.telefono}`}>
										...
										{/* <div className="row mb-3">
											<div className="col-12">
												<div className="info-item">
													...
													<div className="fw-medium">
														<span
															className={`badge ${currentForm.activo ? "badge-verde" : "badge-rojo"}`}
														>
															{currentForm.activo ? "Activo" : "Inactivo"}
														</span>
													</div>
												</div>
											</div>
									...
									<div className="descripcion-section">
										<h6 className="mb-2">Curriculum Vitae</h6>
										{currentForm.file ? (
											<div className="archivos-adjuntos">
												<div className="archivo-item d-inline-block me-2 mb-2">
													<button
											...
											<div className="p-3 bg-light rounded">
												<p className="text-muted mb-0">No se adjuntó CV</p>
											</div>
										)}
									</div>
								</div>
							...
							<Tab.Pane eventKey="responder">
								<div className="p-4">
									<div className="d-flex justify-content-between align-items-center mb-3">
										<h5 className="mb-0">
											Responder Solicitud de Reclutamiento
										</h5>
									</div>
...
export default ModalVerReclutacion;
