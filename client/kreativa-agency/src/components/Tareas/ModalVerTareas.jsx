	...
	const handleAddCommentario = async (event) => {
		...
		try {
			...
			if (response.status === 200) {
				showNotification("success", "Comentario enviado correctamente.");
	...
	return (
		...
		>
			...
			<Modal.Header closeButton>
				<Modal.Title>{tarea?.nombre || "Detalles de la Tarea"}</Modal.Title>
			</Modal.Header>
			<Modal.Body className="p-0">
				{!tarea ? (
					...
					<div className="proyecto-modal-content">
						<Tab.Container id="tarea-tabs" defaultActiveKey="detalles">
							<div className="tabs-header border-bottom">
								<Nav variant="tabs" className="flex-nowrap">
									...
									<Nav.Item>
										<Nav.Link eventKey="comentarios">Comentarios</Nav.Link>
									</Nav.Item>
								</Nav>
							</div>
								...
								<Tab.Pane eventKey="detalles">
									<div className="p-4">
										<div className="d-flex justify-content-between align-items-center mb-3">
											<h5 className="mb-0">Información de la Tarea</h5>
										</div>
										...
										<div className="proyecto-info mb-4">
											...
											<div className="row mb-3">
												<div className="col-md-6">
													<div className="info-item">
														...
														<div className="estado-badge fw-medium">
															{tarea?.colaborador_id?._id === user_id ? (
																<select
												...
												<div className="col-md-6">
													<div className="info-item">
														<div className="text-muted mb-1">Prioridad</div>
											...
											<div className="row mb-3">
												<div className="col-md-6">
													<div className="info-item">
														<div className="text-muted mb-1">Proyecto</div>
														<div className="fw-medium">
															{tarea.proyecto_id
										...
										<div className="descripcion-section">
											...
											<div className="descripcion-content p-3 bg-light rounded">
												{tarea.descripcion ? (
													...
													<p className="text-muted mb-0">Sin descripción</p>
												)}
											</div>
										</div>
									</div>
														...
														>
															<div className="d-flex justify-content-between mb-2">
																...
																<div className="text-end">
																	...
																	{comentario.usuario_id._id === user_id &&
																	tarea.proyecto_id.estado !== "Finalizado" &&
																	tarea.proyecto_id.estado !== "Cancelado" ? (
																		<button
																			className="thm-btn thm-btn-small btn-azul"
																			onClick={() => {
																				setCommentEdit(comentario);
																				setEditando(true);
																			}}
																		>
												...
												<form onSubmit={handleAddCommentario}>
													...
													<div className="form-group mb-3">
														<textarea
															...
															value={
																editando ? commentEdit.contenido : contenido
															}
