	...
	return (
		...
		>
			...
			<Modal.Header closeButton>
				<Modal.Title>{proyecto?.nombre || "Detalles del Proyecto"}</Modal.Title>
			</Modal.Header>
									...
									<div className="p-4">
										...
										<div className="proyecto-info mb-4">
											...
											<div className="row mb-3">
												<div className="col-md-6">
													<div className="info-item">
														<div className="text-muted mb-1">Cliente</div>
														<div className="fw-medium">
															...
															proyecto.colaboradores.length > 0 ? (
																<ul className="list-unstyled mb-0">
																	{proyecto.colaboradores
																		...
																		.map((colaborador) => (
																			<li key={colaborador.colaborador_id._id}>
																				{colaborador.colaborador_id.nombre}
																			</li>
																		))}
																</ul>
															) : (
																<span>Sin colaboradores asignados</span>
															)}
														</div>
													</div>
												</div>
