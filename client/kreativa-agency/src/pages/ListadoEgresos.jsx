...
const ListadoEgresos = () => {
  ...
  return (
    <AdminLayout>
              ...
              {egresosPaginados.length === 0 ? (
                ...
                egresosPaginados.map((egreso) => (
                  <tr key={egreso._id}>
                    ...
                    <td>₡{egreso.monto}</td>
                    <td>{getCategoryName(egreso.categoria)}</td>
                    ...
                    <td>
                      <div className="botones-grupo" style={{ display: "flex", flexDirection: "column", gap: "5px" }}>
                        ...
                        <div style={{ display: "flex", gap: "5px" }}>
                          ...
                          >
                            <FontAwesomeIcon icon={egreso.activo ? faToggleOn : faToggleOff} />
                          </button>
                        </div>
                      </div>
                    </td>
      ...
      <Modal show={showConfirmEditar} onHide={() => setShowConfirmEditar(false)} centered>
        <Modal.Header closeButton>
