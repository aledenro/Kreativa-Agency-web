    ...
    let tareasFiltradas =
        filterColab !== ""
            ? tareas.filter(
                  (tarea) =>
                      (
                          lodash.get(tarea, "colaborador_id._id") ?? ""
    ...
    tareasFiltradas =
        filterStatus !== ""
            ? tareasFiltradas.filter(
                  (tarea) =>
                      (lodash.get(tarea, "estado") ?? "").localeCompare(
                          filterStatus
                      ) === 0
              )
            : tareasFiltradas;
                            ...
                            <Tr>
                                ...
                                {rol === "Administrador" && (
                                    <Th
                                        ...
                                        onClick={() =>
                                            handleSort("colaborador_id.nombre")
                                        }
                                    >
                                        Colaborador{" "}
                                        <span className="sort-icon">
