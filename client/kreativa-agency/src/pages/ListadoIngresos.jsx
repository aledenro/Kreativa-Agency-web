...
const ListadoIngresos = () => {
    ...
    // Filtros globales:
    const [filterEstadoPago, setFilterEstadoPago] =
        useState("Pendiente de pago");
    ...
    if (filterCliente !== "") {
        ingresosFiltrados = ingresosFiltrados.filter(
            (ingreso) =>
                ingreso.nombre_cliente.toLowerCase() ===
                filterCliente.toLowerCase()
        );
    }
    if (filterFecha !== "") {
    ...
    return (
        <AdminLayout>
            ...
            <Modal
                show={showConfirmCrear}
                onHide={() => setShowConfirmCrear(false)}
            >
                <Modal.Header closeButton>
